...
let matchId =30880;
let innings=1;
let batsmenColumns =["playersName", "out", "runs", "ballsPlayed", "fours", "sixes", "strikeRate"];
let innings1Batsmen =[];


async function main(){
    await browser.get(`https://www.cricbuzz.com/live-cricket-scores/${matchId}`); //for variable ids
    await browser.wait(wd.until.elementsLocated(wd.By.css(".cb-nav-bar a"))); //waiting till the page gets load!
